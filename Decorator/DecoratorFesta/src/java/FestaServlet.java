...
import festa.dominio.adicionais.Banda;
import festa.dominio.adicionais.Dj;
import festa.dominio.adicionais.TempoAdd2Horas;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameterMap() != null) {
                ...
                if (request.getParameterMap().containsKey("tempoAdd2Horas")) {
                    festa = new TempoAdd2Horas(festa);
                }
